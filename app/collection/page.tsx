...
import Link from "next/link"
 export default function home(){
  ...
  return <div>
    <h1 className="font-serif text-white bg-blue-900 h-40 py-5 text-lg  text-white hover:text-yellow-500">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nam quisquam, molestiae tempore voluptates error quidem ratione repellat voluptatem odio vel, adipisci veniam laboriosam! Tempora soluta iste debitis.
